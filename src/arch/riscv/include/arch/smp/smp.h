 ...
 * to working_hartid can be returned from smp_push, other harts will
 * enter halt and waitting for wakeup
 */
void smp_pause(int working_hartid);

/*
 * This function is used to wake up the hart that is halted by the
